...
(
	COD_PER_CARAC INT PRIMARY KEY IDENTITY NOT NULL,
...
(
	COD_PAR_RESULT INT PRIMARY KEY IDENTITY NOT NULL,
...
FOREIGN KEY (COD_PER)
REFERENCES Personagem (COD_PER)

ALTER TABLE Personagem
ADD CONSTRAINT Fk_Personagem
FOREIGN KEY (COD_PER_CARAC)
REFERENCES Personagem_Caracteristica (COD_PER_CARAC)
...
FOREIGN KEY (COD_PAR_RESULT)
REFERENCES Partida_Resultados (COD_PAR_RESULT)
...
SELECT * FROM Personagem p, Caracteristica c, Personagem_Caracteristica pc WHERE p.COD_PER_CARAC = pc.COD_PER_CARAC AND c.COD_PER_CARAC = pc.COD_PER_CARAC
...
SELECT * FROM Partida p, Resultados r, Partida_Resultados pr WHERE p.COD_PAR_RESULT = pr.COD_PAR_RESULT AND pr.COD_PAR_RESULT = r.COD_PAR_RESULT
